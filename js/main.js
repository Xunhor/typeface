(function ($) {
  ...
  var cfg = {
      ...
      mailChimpURL:
        "https://hotmail.us21.list-manage.com/subscribe/post?u=3434a2e4a1e35237686ec0c81&amp;id=1875ba7420&amp;f_id=0096f9e1f0", // mailchimp url
    },
    $WIN = $(window);
  ...
  var clAjaxChimp = function () {
    ...
    //  5: 'Este endereço de e-mail parece falso ou inválido. Por favor, insira um endereço de e-mail real'

    $.ajaxChimp.translations.es = {
      submit: "Enviando...",
      0: '<i class="fa fa-check"></i> Enviamos um e-mail de confirmação',
